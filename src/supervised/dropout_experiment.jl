...
function main(;gamesfile::String, epochs::Int=10, batchsize::Int=64,
	...
	model = SupervisedModel.DropoutClassifier(cardembed=cardembed, bidembed=bidembed, vulembed=vulembed,
								lstmhidden = lstmhidden, mlphidden=mlphidden, lstmdropout=lstmdropout,
