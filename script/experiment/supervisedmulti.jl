...
function main(args::Vector{String})
    s = ArgParseSettings()
    s.description = "Supervised Multi-Head Experiment for Bridge Bidding"
...
function main(;gamesfile::String, epochs::Int=10, batchsize::Int=64,
    ...
    @info "Bridge Bidding Supervised Multi-Head Experiment"
    if train
    ...
    evaluator = SupervisedMultiEvaluator(take(dtrn,div(length(dtrn),10)), dtst, onnewbest = savefun)
